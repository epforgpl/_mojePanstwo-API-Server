...
foreach(array('', '_v0') as $version) {
    ...
    Router::connect("$base_slug$version/:letter_id/responses/:response_id", array('plugin' => 'Pisma', 'controller' => 'Responses', 'action' => 'update', '[method]' => 'POST'), array('letter_id' => '[A-Za-z0-9]{5}', 'response_id' => '[0-9]{1,}', 'pass' => array('letter_id', 'response_id')));
